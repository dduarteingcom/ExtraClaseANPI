...
# Esta es la función que se desea interpolar
# ---------------------------------------------------------------
def y_exacta(x):
    """
    Función exacta.
...
def Lk(x, k, x_val):
    ...
    Args:
        ...
        k (int): Índice.
        x_val (list or np.array): Lista de nodos x_i.
...
def polinomio_lagrange(x_val, y_val):
    ...
    Args:
        x_val (list or np.array): Nodos x_i.
        y_val (list or np.array): Valores y_i = f(x_i).

    Returns:
        Polinomio simbólico interpolante P(x).
    """
    x = sp.Symbol('x')
    p_x = 0
...
# ---------------------------------------------------------------
# Graficación: función exacta, puntos dados e interpolación
# ---------------------------------------------------------------
